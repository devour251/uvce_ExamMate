// Centralised API client. Talks to the Express server.
...
export const api = {
  ...
  uploadNotes: async (
    ...
    return res.json() as Promise<{ chunks_indexed: number; file_name: string; success: boolean }>;
  },
};
