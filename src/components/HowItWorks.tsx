...
const STEPS = [
  {
    ...
    body: "Eight semesters, every UVCE subject — your syllabus PDF is right inside.",
  },
  {
    n: "02",
    ...
    <section className="relative py-28 px-6">
      <div className="container max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <div className="text-xs uppercase tracking-[0.3em] text-accent/80 mb-4 font-mono font-bold">
            How it works
          </div>
        ...
        <div className="relative">
          ...
          <div className="space-y-10">
            {STEPS.map((s, i) => (
              ...
              >
                <div className="hidden md:flex absolute left-0 top-1 h-12 w-12 items-center justify-center rounded-full bg-ink-900 border border-accent/40 text-accent font-mono shadow-[0_0_30px_-5px_rgba(245,184,0,0.5)] font-bold text-sm">
                  {s.n}
                </div>
                <div className="glass rounded-2xl p-6">
                  ...
                  <p className="mt-2 text-ink-200/70 leading-relaxed text-sm">
                    {s.body}
                  </p>
                </div>
              </motion.div>
