...
export default function CommunityUpload() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      console.log("[upload] posting to:", `/api/community/upload`);
        ...
        <div className="relative">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <h2 className="font-display text-2xl md:text-3xl font-bold">
                Contribute to <span className="gradient-text italic font-bold">UVCE</span> Knowledge Base
              </h2>
            </div>
          </div>
          <p className="text-ink-200/75 mb-8 max-w-2xl text-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-xl bg-ink-900 border border-white/10 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-accent/40 text-ink-100"
                >
            ...
            <div>
              ...
              <p className="mt-1.5 text-[10px] text-ink-300/60 font-mono">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl bg-ink-900/80 border border-white/10 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-accent/40 text-ink-100"
                />
              </div>
              <div>
                <label className="block text-xs uppercase tracking-widest text-ink-300/80 mb-2">
            ...
            <div>
              ...
              <label className="flex items-center gap-3 cursor-pointer rounded-xl bg-ink-900/80 border-2 border-dashed border-white/15 hover:border-accent/40 transition px-4 py-5">
                ...
                {file && (
                  <span className="text-xs text-ink-300/60 font-mono">
              ...
              <div className="flex items-center gap-3 rounded-xl bg-emerald-500/10 border border-emerald-500/30 px-4 py-3 text-sm">
                ...
                <div className="flex-1">
                  <div className="font-medium text-emerald-300">
                    Uploaded <span className="font-mono">{result.file_name}</span>
                  </div>
                  <div className="text-xs text-ink-300/80 font-mono">
                    {result.chunks} chunks indexed · region:{" "}
                    <span className="font-mono text-accent">{result.mode}</span>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-xs text-ink-300/60 flex items-center gap-1.5 font-mono">
